...
//use crate::storage::{NodeStorage, MetadataStorage, metadata::Metadata};
//use anyhow::Result;
//
//enum WriteOp<K, V> {
//    Insert(K, V),
...
//    staged_root_id: u64,
//    staged_metadata: Metadata, // Staged metadata root ID
//    initial_root_id: u64, // Initial root ID at transaction start
...
//        Self {
//            tree,
//            initial_root_id: staged_root_id, // Store initial root ID for reference
//            staged_root_id,
//            staged_metadata: tree.metadata().clone(), // Get
//            // initial metadata
//            changes: Vec::new(),
...
//                //self.tree.try_commit(self.initial_root, self.staged_metadata)?;
//                self.tree.commit(
//                    self.staged_root_id,
//                )?;
